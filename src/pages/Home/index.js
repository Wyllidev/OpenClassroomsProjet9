...
const Page = () => {
  // Les const data et last sont utilisées pour gérer les données récupérées et pour extraire le dernier évènement d'une liste
	const { data } = useData();
		...
		<>
          ...
          {/* Ajout d'un id */}
				...
				<div className="FormContainer" id="contact">
					...
					>
						{({ setIsOpened }) => (
              // Suppression des retours à la ligne inutile
          ...
          {/* Cette condition vérifie si l'objet last et les propriétés cover et title de cet objet existe si oui affichage du composant EventCard */}
					{last && last.cover && last.title ? (
						<EventCard
							...
							label="boom"
						/>
            // Si les conditions ne sont pas remplis, rien ne s'affichera
					) : null}
				</div>
