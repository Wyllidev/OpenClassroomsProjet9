...
const Select = ({
    ...
    // Appel d'une fonction `onChange` avec `newValue` comme argument
    // Passer newValue à onChange garantit que le composant parent est informé du changement et peut gérer la nouvelle valeur de manière appropriée
		onChange(newValue);
		setValue(newValue);
